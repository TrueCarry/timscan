...
<template>
  <span class="ui-copy flex items-center gap-1">
    ...
    <span v-if="showButton">
      ...
      >
        <g v-pre fill="none" fill-rule="evenodd">
          <path d="M0 0h14v14H0z" />
          <path
            d="M6.36 3.35h3.29a2 2 0 0 1 2 2v5.3a2 2 0 0 1-2 2H6.36a2 2 0 0 1-2-2v-5.3a2 2 0 0 1 2-2Z"
            stroke="currentColor"
            stroke-width="1.3"
            stroke-linejoin="round"
          />
          <path
            d="M2 10.65V3.3A2.3 2.3 0 0 1 4.3 1h5.4"
            stroke="currentColor"
            stroke-width="1.3"
            stroke-linejoin="round"
          />

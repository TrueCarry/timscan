...
export const Functions = {
  ...
  liteServer_getVersion: {
    encodeRequest: (src: liteServer_getVersion, encoder: TLWriteBuffer) => {
  ...
  liteServer_getBlock: {
    encodeRequest: (src: liteServer_getBlock, encoder: TLWriteBuffer) => {
  ...
  liteServer_getState: {
    encodeRequest: (src: liteServer_getState, encoder: TLWriteBuffer) => {
  ...
  liteServer_getBlockHeader: {
    encodeRequest: (src: liteServer_getBlockHeader, encoder: TLWriteBuffer) => {
  ...
  liteServer_sendMessage: {
    encodeRequest: (src: liteServer_sendMessage, encoder: TLWriteBuffer) => {
  ...
  liteServer_runSmcMethod: {
    encodeRequest: (src: liteServer_runSmcMethod, encoder: TLWriteBuffer) => {
  ...
  liteServer_getShardInfo: {
    encodeRequest: (src: liteServer_getShardInfo, encoder: TLWriteBuffer) => {
  ...
  liteServer_lookupBlock: {
    encodeRequest: (src: liteServer_lookupBlock, encoder: TLWriteBuffer) => {
  ...
  liteServer_getConfigAll: {
    encodeRequest: (src: liteServer_getConfigAll, encoder: TLWriteBuffer) => {
  ...
  liteServer_queryPrefix: {
    encodeRequest: (src: liteServer_queryPrefix, encoder: TLWriteBuffer) => {
      encoder.writeInt32(1926489734)
      Codecs.liteServer_queryPrefix.encode(src, encoder)
    },
    decodeResponse: (decoder: TLReadBuffer) => decoder.readObject(),
  } as TLFunction<liteServer_queryPrefix, TLBytes>,

  liteServer_query: {
    encodeRequest: (src: liteServer_query, encoder: TLWriteBuffer) => {
      encoder.writeInt32(2039219935)
      Codecs.liteServer_query.encode(src, encoder)
    },
    decodeResponse: (decoder: TLReadBuffer) => decoder.readObject(),
...
export const Codecs = {
  tonNode_blockId: {
    ...
    decode: (decoder: TLReadBuffer): tonNode_blockId => {
      const workchain = decoder.readInt32()
      const shard = decoder.readInt64()
      const seqno = decoder.readInt32()
  ...
  tonNode_blockIdExt: {
    ...
    decode: (decoder: TLReadBuffer): tonNode_blockIdExt => {
      ...
      const shard = decoder.readInt64()
      const seqno = decoder.readInt32()
      const rootHash = decoder.readInt256()
      const fileHash = decoder.readInt256()
  ...
  liteServer_masterchainInfo: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_masterchainInfo => {
      const last = Codecs.tonNode_blockIdExt.decode(decoder)
      const stateRootHash = decoder.readInt256()
      const init = Codecs.tonNode_zeroStateIdExt.decode(decoder)
  ...
  liteServer_masterchainInfoExt: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_masterchainInfoExt => {
      const mode = decoder.readUInt32()
      const version = decoder.readInt32()
      const capabilities = decoder.readInt64()
      const last = Codecs.tonNode_blockIdExt.decode(decoder)
      const lastUtime = decoder.readInt32()
      const now = decoder.readInt32()
      const stateRootHash = decoder.readInt256()
      const init = Codecs.tonNode_zeroStateIdExt.decode(decoder)
      return {
  ...
  liteServer_blockData: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_blockData => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const data = decoder.readBuffer()
  ...
  liteServer_blockHeader: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_blockHeader => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const mode = decoder.readUInt32()
      const headerProof = decoder.readBuffer()
  ...
  liteServer_accountState: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_accountState => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const shardblk = Codecs.tonNode_blockIdExt.decode(decoder)
      const shardProof = decoder.readBuffer()
      const proof = decoder.readBuffer()
      const state = decoder.readBuffer()
  ...
  liteServer_runMethodResult: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_runMethodResult => {
      ...
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const shardblk = Codecs.tonNode_blockIdExt.decode(decoder)
      const shardProof = mode & (1 << 0) ? decoder.readBuffer() : null
      const proof = mode & (1 << 0) ? decoder.readBuffer() : null
      const stateProof = mode & (1 << 1) ? decoder.readBuffer() : null
      const initC7 = mode & (1 << 3) ? decoder.readBuffer() : null
      const libExtras = mode & (1 << 4) ? decoder.readBuffer() : null
      const exitCode = decoder.readInt32()
      const result = mode & (1 << 2) ? decoder.readBuffer() : null
      return {
  ...
  liteServer_shardInfo: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_shardInfo => {
      ...
      const shardblk = Codecs.tonNode_blockIdExt.decode(decoder)
      const shardProof = decoder.readBuffer()
      const shardDescr = decoder.readBuffer()
  ...
  liteServer_transactionInfo: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_transactionInfo => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const proof = decoder.readBuffer()
      const transaction = decoder.readBuffer()
  ...
  liteServer_transactionList: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_transactionList => {
      const ids = decoder.readVector(Codecs.tonNode_blockIdExt.decode)
      const transactions = decoder.readBuffer()
  ...
  liteServer_transactionId: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_transactionId => {
      const mode = decoder.readUInt32()
      const account = mode & (1 << 0) ? decoder.readInt256() : null
      const lt = mode & (1 << 1) ? decoder.readInt64() : null
      const hash = mode & (1 << 2) ? decoder.readInt256() : null
  ...
  liteServer_transactionId3: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_transactionId3 => {
      const account = decoder.readInt256()
      const lt = decoder.readInt64()
  ...
  liteServer_blockTransactions: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_blockTransactions => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const reqCount = decoder.readUInt32()
      const incomplete = decoder.readBool()
      const ids = decoder.readVector(Codecs.liteServer_transactionId.decode)
      const proof = decoder.readBuffer()
  ...
  liteServer_signatureSet: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_signatureSet => {
      ...
      const signatures = decoder.readVector(Codecs.liteServer_signature.decode)
  ...
  liteServer_blockLinkBack: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_blockLinkBack => {
      ...
      const proof = decoder.readBuffer()
      const stateProof = decoder.readBuffer()
      return {
  ...
  liteServer_blockLinkForward: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_blockLinkForward => {
      ...
      const signatures = Codecs.liteServer_SignatureSet.decode(decoder)
      return {
  ...
  liteServer_partialBlockProof: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_partialBlockProof => {
      ...
      const from = Codecs.tonNode_blockIdExt.decode(decoder)
      const to = Codecs.tonNode_blockIdExt.decode(decoder)
      const steps = decoder.readVector(Codecs.liteServer_BlockLink.decode)
  ...
  liteServer_validatorStats: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_validatorStats => {
      ...
      const complete = decoder.readBool()
      const stateProof = decoder.readBuffer()
      const dataProof = decoder.readBuffer()
  ...
  liteServer_getAccountState: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_getAccountState => {
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const account = Codecs.liteServer_accountId.decode(decoder)
  ...
  liteServer_runSmcMethod: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_runSmcMethod => {
      ...
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const account = Codecs.liteServer_accountId.decode(decoder)
      const methodId = decoder.readInt64()
      const params = decoder.readBuffer()
  ...
  liteServer_lookupBlock: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_lookupBlock => {
      const mode = decoder.readUInt32()
      const id = Codecs.tonNode_blockId.decode(decoder)
      const lt = mode & (1 << 1) ? decoder.readInt64() : null
      const utime = mode & (1 << 2) ? decoder.readInt32() : null
  ...
  liteServer_listBlockTransactions: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_listBlockTransactions => {
      ...
      const mode = decoder.readUInt32()
      const count = decoder.readUInt32()
      const after = mode & (1 << 7) ? Codecs.liteServer_transactionId3.decode(decoder) : null
      const reverseOrder = mode & (1 << 6) ? decoder.readBool() : null
      const wantProof = mode & (1 << 5) ? decoder.readBool() : null
      return {
  ...
  liteServer_getBlockProof: {
    encode: (src: liteServer_getBlockProof, encoder: TLWriteBuffer) => {
      ...
      src.mode & (1 << 0) &&
        !!src.targetBlock &&
        Codecs.tonNode_blockIdExt.encode(src.targetBlock, encoder)
    },
    decode: (decoder: TLReadBuffer): liteServer_getBlockProof => {
      const mode = decoder.readUInt32()
      const knownBlock = Codecs.tonNode_blockIdExt.decode(decoder)
      const targetBlock = mode & (1 << 0) ? Codecs.tonNode_blockIdExt.decode(decoder) : null
  ...
  liteServer_getConfigParams: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_getConfigParams => {
      const mode = decoder.readUInt32()
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const paramList = decoder.readVector((d) => d.readInt32())
  ...
  liteServer_getValidatorStats: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_getValidatorStats => {
      const mode = decoder.readUInt32()
      const id = Codecs.tonNode_blockIdExt.decode(decoder)
      const limit = decoder.readInt32()
      const startAfter = mode & (1 << 0) ? decoder.readInt256() : null
      const modifiedAfter = mode & (1 << 2) ? decoder.readInt32() : null
  ...
  liteServer_waitMasterchainSeqno: {
    ...
    decode: (decoder: TLReadBuffer): liteServer_waitMasterchainSeqno => {
      const seqno = decoder.readInt32()
      const timeoutMs = decoder.readInt32()
